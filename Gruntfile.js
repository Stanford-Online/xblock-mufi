module.exports = function (grunt) {
    ...
    var directoryPackage = './xblockmufi';
    ...
    grunt.initConfig({
        ...
        htmlmin: {
            all: {
                ...
                files: {
                    'xblockmufi/public/edit.html': directoryPrivate + '/edit.html',
                    'xblockmufi/public/view.html': directoryPrivate + '/view.html',
                },
            },
        },
        jshint: {
        ...
        less: {
            view: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'xblockmufi/public/view.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    'xblockmufi/public/view.less.min.css':
            ...
            edit: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'xblockmufi/public/edit.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
